    ...
    <>
      <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 text-white">
        ...
        <div className="w-full">
          <header className="w-auto bg-opacity-90 backdrop-blur-md text-white py-6 text-center text-4xl font-extrabold shadow-2xl tracking-wide mb-8 flex justify-between p-2">
            
              <div className="w-1/2 p-2 mr-2">
              <img src={logo} width={250} alt="images" />
              </div>

              <div className="w-1/2 p-2 ml-2 tex">
